...
<body class="landing-body">
          ...
          <div class="grid">
            ...
            <div class="full skills-section">
              ...
              <div class="skills-container">
                <input type="text" class="skills-search" placeholder="ðŸ” Search skills..." id="jsSkillsSearch">
        ...
        <form method="POST" action="/QuickHire/Public/actions/save_profile.php" enctype="multipart/form-data">
          ...
          <div class="grid">
            ...
            <div class="full skills-section">
              ...
              <div class="skills-container">
                <input type="text" class="skills-search" placeholder="ðŸ” Search skills..." id="empSkillsSearch">
  ...
  <?php require __DIR__ . '/../Partials/scripts/complete-profile-script-1.php'; ?>
</body>
</html>

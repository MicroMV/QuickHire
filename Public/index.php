...
<section class="ln-hero">
  ...
  <div class="ln-hero-content">
    <div class="ln-badge">âš¡ Smart Skill-Based Matching</div>
    ...
    <div class="ln-hero-ctas">
      <a href="#" class="ln-btn-primary ln-btn-lg" id="heroGetHired">Find Jobs â†’</a>
  ...
  <div class="ln-hero-preview">
    <div class="ln-preview-card ln-preview-main">
      ...
      <div class="ln-preview-job">
        ...
        <div class="ln-pjob-info"><strong>Senior Frontend Dev</strong><span>TechCorp Â· Remote Â· $85/hr</span></div>
        <div class="ln-pjob-badge ln-badge-green">98% match</div>
      </div>
      <div class="ln-preview-job">
        <div class="ln-pjob-avatar" style="background:#ec4899;">PY</div>
        <div class="ln-pjob-info"><strong>Python Backend Engineer</strong><span>DataFlow Â· US Â· $70/hr</span></div>
        <div class="ln-pjob-badge ln-badge-blue">91% match</div>
      </div>
      <div class="ln-preview-job">
        <div class="ln-pjob-avatar" style="background:#f59e0b;">UX</div>
        <div class="ln-pjob-info"><strong>UI/UX Designer</strong><span>Pixel Studio Â· UK Â· $60/hr</span></div>
...
<section class="ln-features" id="features">
  ...
  <div class="ln-features-grid">
    <div class="ln-feat-card">
      <div class="ln-feat-icon" style="background:rgba(99,102,241,0.15);color:#818cf8;">âš¡</div>
...
<section class="ln-categories" id="categories">
  ...
  <div class="ln-search-bar">
    <span class="ln-search-icon">ðŸ”</span>
  ...
  <div class="ln-categories-grid">
    <div class="ln-cat-card"><div class="ln-cat-icon">âš›ï¸</div><span>Frontend Dev</span></div>
    <div class="ln-cat-card"><div class="ln-cat-icon">ðŸ–¥ï¸</div><span>Backend Dev</span></div>
    <div class="ln-cat-card"><div class="ln-cat-icon">ðŸ“±</div><span>Mobile Dev</span></div>
    <div class="ln-cat-card"><div class="ln-cat-icon">â˜ï¸</div><span>Cloud / DevOps</span></div>
    <div class="ln-cat-card"><div class="ln-cat-icon">ðŸŽ¨</div><span>UI/UX Design</span></div>
    <div class="ln-cat-card"><div class="ln-cat-icon">ðŸ¤–</div><span>AI / ML</span></div>
    <div class="ln-cat-card"><div class="ln-cat-icon">ðŸ”’</div><span>Security</span></div>
    <div class="ln-cat-card"><div class="ln-cat-icon">ðŸ“Š</div><span>Data Science</span></div>
  </div>
</section>
...
<footer class="ln-footer">
  ...
  <div class="ln-footer-bottom">Â© 2025 QuickHire. All rights reserved.</div>
</footer>
...
<div class="ln-sidebar-overlay" id="authModal">
  <div class="ln-sidebar">
    <div class="ln-sidebar-header">
      ...
      <button class="ln-sidebar-close" id="closeModal">âœ•</button>
    </div>
    ...
    <form id="registerForm" class="ln-auth-form" style="display:none;" method="POST" action="/QuickHire/Public/actions/register.php">
      ...
      <div class="ln-role-toggle">
        <label class="ln-role-opt">
          ...
          <span>ðŸ‘¨â€ðŸ’» I'm a Jobseeker</span>
        </label>
        <label class="ln-role-opt">
          <input type="radio" name="role" value="EMPLOYER">
          <span>ðŸ¢ I'm an Employer</span>
        </label>
      </div>
...
<?php require __DIR__ . '/../Partials/scripts/index-script-1.php'; ?>
</body>
</html>
